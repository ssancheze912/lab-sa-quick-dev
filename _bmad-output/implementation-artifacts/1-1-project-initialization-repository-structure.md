...
- `frontend/components.json` (shadcn config with Siesa aliases)
...
Removed (default Vite template scaffold): `frontend/src/App.tsx`, `frontend/src/App.css`, `frontend/src/assets/react.svg`.
