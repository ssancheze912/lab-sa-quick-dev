...
#### Modified
- `frontend/src/routes/__root.tsx` — added data-testid attributes: nav-rail, nav-rail-{id}, nav-bar, nav-bar-{id}, not-found-view, not-found-message; overlay button pattern for per-item E2E targeting
