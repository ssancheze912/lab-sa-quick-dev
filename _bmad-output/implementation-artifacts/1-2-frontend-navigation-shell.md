...
- All 10 tests pass: navigation rendering, routing, active state, redirect, 404, ARIA labels
...
#### Modified
- `frontend/src/routes/__root.tsx` — full rewrite with NavigationRail/Bar layout
