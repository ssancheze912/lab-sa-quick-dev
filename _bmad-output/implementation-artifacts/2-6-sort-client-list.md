...
- [ ] Task 1 — Frontend: `SortControl` shared component + sort comparator (AC: #1, #2, #3, #4, #6)
  - [ ] Create `frontend/src/shared/components/SortControl.tsx`. Export:
