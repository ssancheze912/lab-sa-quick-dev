...
### 0. Feature-Specific Requirements Elicitation (ONLY if Technical Preference is selected)

**If "Feature-Specific Technical Preference" was selected:**

Before diving into standard categories, you MUST ask the user about their specific vision for this feature building upon the existing project context.

Present to user:
"Since we are creating a Technical Preference for *[Feature Name]* and we already have a General Project Context, I need you to detail the specific technical direction for this feature.

Please tell me:
1. What are the specific architectural or design patterns unique to this feature?
2. Are there any specific libraries, APIs, or tools exclusive to this implementation?
3. What strict rules, constraints, or 'gotchas' apply ONLY to this feature and aren't covered in the general context?

Please detail these preferences as much as possible so I can build a tailored and non-redundant context for the agents."

**Action:**
1. Wait for the user's detailed reply.
2. Analyze their response.
3. Keep this feature-specific knowledge in your memory.
4. During the subsequent steps (1 through 7), **ONLY** ask the user about a category and generate rules for it IF it is directly relevant to the feature-specific details they just provided. Skip categories that are entirely covered by the general project context and have no feature-specific variations.
...
When user selects 'C' for a category, append the content directly to your target `{output_file}` (either project-context.md or technical-preference.md) using the structure from step 8.
