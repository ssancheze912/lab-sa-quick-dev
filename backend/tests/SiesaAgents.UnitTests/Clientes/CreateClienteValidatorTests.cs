...
/// <summary>
/// ATDD unit tests — Story 2.3: CreateClienteRequestValidator (RED phase)
/// Tests fail until CreateClienteRequestValidator and CreateClienteRequest are implemented.
///
/// Test IDs covered:
///   TC-E2-2-3-UNIT-1 (P2) — Validator rejects null Nombre
///   TC-E2-2-3-UNIT-2 (P2) — Validator rejects null Nit
///   TC-E2-2-3-UNIT-3 (P2) — Validator rejects null Telefono
///   TC-E2-2-3-UNIT-4 (P2) — Validator rejects null Ciudad
/// </summary>
public class CreateClienteValidatorTests
{
    ...
    /// <summary>
    /// TC-E2-2-3-UNIT-1 (P2)
    /// GIVEN a CreateClienteRequest with Nombre set to null or empty
    ...
    /// <summary>
    /// TC-E2-2-3-UNIT-2 (P2)
    /// GIVEN a CreateClienteRequest with Nit set to null or empty
    /// WHEN the validator is invoked
    ...
    /// <summary>
    /// TC-E2-2-3-UNIT-3 (P2)
    /// GIVEN a CreateClienteRequest with Telefono set to null or empty
    /// WHEN the validator is invoked
    ...
    /// <summary>
    /// TC-E2-2-3-UNIT-4 (P2)
    /// GIVEN a CreateClienteRequest with Ciudad set to null or empty
    /// WHEN the validator is invoked
