 ...
 * RED Phase: These tests are intentionally FAILING until implementation is complete.
 *
...
// ─── Minimal route tree for isolated component testing ──────────────────────
// These mirrors the implementation structure defined in Story 1.2 tasks.
// Tests will fail until the actual implementation files are created.

function createTestRouter(initialPath: string) {
  const history = createMemoryHistory({ initialEntries: [initialPath] })

  // Import the actual route tree generated by TanStack Router plugin
  // This will fail until src/routeTree.gen.ts is auto-generated with Story 1.2 routes
