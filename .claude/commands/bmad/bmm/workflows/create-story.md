...
<steps CRITICAL="TRUE">
1. FIRST: LOAD and READ the FULL @_siesa-agents/bmm/workflows/4-implementation/create-story/workflow_ext.md — This contains mandatory context injection rules. Apply them throughout the workflow execution.
